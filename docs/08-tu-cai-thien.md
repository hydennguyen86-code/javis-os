...
Trang "Tự cải thiện" cho phép Javis tự thức theo lịch, làm **một nhiệm vụ cụ thể** rồi tự kiểm chứng và ghi nhật ký, mà không cần bạn ngồi gõ lệnh. Đây là "vòng lặp tự cải thiện" chạy nền ngay trên máy/VPS của bạn.
...
Hãy hình dung một trợ lý nền: cứ mỗi khoảng thời gian bạn đặt (ví dụ 60 phút), Javis tự mở vault ra, chọn đúng một việc theo mục tiêu bạn cấu hình, làm việc đó, rồi ghi lại kết quả vào nhật ký. Nếu bạn để chế độ "Tự làm", nó còn chạy thêm một bước tự kiểm chứng để soi xem việc vừa làm có đáng tin không.

Bốn kiểu nhiệm vụ có sẵn:

| Loại nhiệm vụ | Mã | Javis làm gì |
|---|---|---|
...
Ở mục **Loại nhiệm vụ**, bấm một trong bốn nút: **Kinh doanh**, **Bộ não (Wiki)**, **Cải thiện Javis**, hoặc **Tự định nghĩa**. Nút được chọn sẽ sáng màu cam. Ngay dưới đó có một dòng mô tả ngắn nhắc bạn loại nhiệm vụ đó làm gì.
...
Nếu bạn mới dùng, hãy bắt đầu bằng **Đề xuất (ghi nháp)** cho an tâm, xem Javis đề xuất gì trước, rồi mới chuyển sang **Tự làm + kiểm chứng** khi đã tin tưởng.

Ở chế độ "Tự làm", Javis chỉ được dùng bộ công cụ file (đọc, viết, sửa). Ở chế độ "Đề xuất", nó còn bị siết chặt hơn: chỉ được đọc.
...
Lưu ý: bộ đếm lịch của Javis kiểm tra mỗi khoảng ngắn xem đã tới hạn chưa, nên thời điểm chạy thật có thể lệch vài chục giây so với con số bạn đặt. Điều này bình thường.
...
Đây là chế độ linh hoạt nhất. Khi chọn **Tự định nghĩa**, ô "Mô tả nhiệm vụ cụ thể" hiện ra. Bạn viết bằng lời thường, càng cụ thể càng tốt: nói rõ Javis đọc gì, làm gì, và lưu kết quả vào đâu.
...
Không muốn chờ tới chu kỳ? Bấm **▶ Chạy ngay**. Javis lưu cấu hình hiện tại rồi khởi động ngay một vòng. Nút đổi thành "Đang chạy..." trong giây lát. Sau đó xem ô trạng thái và "Nhật ký gần đây" để đọc kết quả.
...
Khi bạn để **Tự làm + kiểm chứng** và Javis thật sự có làm việc gì đó, nó chạy thêm một lượt kiểm tra độc lập: một "người soi" giả định kết quả vừa rồi là SAI, rồi đọc lại file liên quan để đối chiếu. Tiêu chí kiểm tra tùy loại nhiệm vụ:
...
Kết quả kiểm chứng hiện dưới dạng **✓ Đạt** hoặc **✗ Chưa đạt** kèm lý do ngắn, cả trong ô trạng thái lẫn trong nhật ký. Đây là lưới an toàn thứ hai, giúp bạn không phải tin mù vào việc Javis tự làm.
...
Bấm nút, Javis quét thư mục Wiki và trả về một **danh sách kiểm tra** gồm 8 loại vấn đề thường gặp:
...
LINT **chỉ đọc và liệt kê, không tự sửa**. Bạn xem danh sách rồi tự quyết định muốn sửa gì. Nếu Wiki sạch, Javis sẽ nói rõ. Muốn hiểu sâu hơn về Wiki và bộ nhớ, xem [Second Brain: bộ nhớ, Wiki, INGEST](13-second-brain-bo-nho-wiki.md).

## An toàn: những gì Javis KHÔNG làm ở đây
...
- **KHÔNG** sửa code của server Javis.

Nói cách khác, tệ nhất thì nó tạo ra một note nháp không hay; nó không thể làm điều gì gây tốn tiền hay ảnh hưởng ra bên ngoài. Nếu bạn muốn Javis thật sự thực thi hành động ra ngoài (gửi tin, tạo đơn...), việc đó nằm ở luồng trò chuyện có bạn giám sát, không phải ở vòng lặp nền này.

## Mẹo

1. **Bắt đầu bằng chế độ Đề xuất.** Cho Javis chạy vài vòng ở "Đề xuất (ghi nháp)" để xem chất lượng đề xuất, rồi mới bật "Tự làm + kiểm chứng".
...
6. **Đọc nhật ký sau vài ngày.** Sau khi bật, thỉnh thoảng ghé lại xem "Nhật ký gần đây" để biết Javis đang làm gì và điều chỉnh mục tiêu nếu cần.
...
**Kết quả báo "Claude CLI chưa cài".** Bộ não Javis (Claude Code CLI) chưa sẵn sàng. Xem [Bắt đầu & thiết lập lần đầu](01-bat-dau-thiet-lap.md) và [Khắc phục sự cố & FAQ](17-khac-phuc-su-co.md).
...
- [Quản lý tệp tin](05-quan-ly-tep-tin.md) - mở file nhật ký và note nháp Javis tạo ra.
