...
Trang "Tệp tin" là trình quản lý tệp ngay trong dashboard Javis. Bạn duyệt thư mục, mở và sửa file văn bản (.md, .txt...) trực tiếp trên trình duyệt rồi lưu, tải file lên, tải file về, tạo thư mục, đổi tên và xoá. Tất cả thao tác diễn ra bên trong "brain" (bộ não) mà bạn đang chọn, không cần mở File Explorer hay dùng lệnh.
...
Mọi thao tác bị giới hạn trong phạm vi brain đang chọn. Javis chặn các đường dẫn cố đi ra ngoài thư mục brain, nên bạn không thể vô tình chạm vào file hệ thống.

## Mở ở đâu trong Javis

1. Mở dashboard Javis (mặc định ở cổng 7777).
2. Nhìn thanh điều hướng bên trái, bấm mục **Tệp tin** (biểu tượng thư mục).
3. Trang hiện thanh công cụ ở trên và danh sách file/thư mục ở dưới. Lần đầu vào, Javis hiển thị thư mục gốc của brain đang chọn.

Nếu danh sách báo lỗi kiểu "Máy chủ Javis chưa có chức năng Tệp tin", hãy khởi động lại server (chạy `stop-jarvis.bat` rồi `start-jarvis.vbs`) và tải lại trang. Xem thêm [Khắc phục sự cố & FAQ](17-khac-phuc-su-co.md).
...
Ký tự lạ trong tên sẽ được Javis thay bằng dấu gạch dưới cho an toàn, nên tên thực tế có thể khác nhẹ so với tên bạn gõ.
...
Cảnh báo: thao tác xoá không có thùng rác, không hoàn tác được. Hãy chắc chắn trước khi xác nhận. Javis không cho phép xoá thư mục gốc của brain.
...
**Danh sách báo "Máy chủ Javis chưa có chức năng Tệp tin".** Server đang chạy bản cũ chưa có tính năng này. Khởi động lại server (`stop-jarvis.bat` rồi `start-jarvis.vbs`) và tải lại trang.
