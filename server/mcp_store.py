"""
Quản lý MCP server cho engine Claude Code (Javis làm chủ danh sách).
...
def servers_for_client():
    """Server http/sse đang bật + headers THẬT - cho MCP client của Javis (model API/OAuth dùng MCP)."""
    out = []
